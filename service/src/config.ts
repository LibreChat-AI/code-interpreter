...
export const env = {
  ...
  PTC_MAX_TOOL_RESULT_BYTES: Number(process.env.PTC_MAX_TOOL_RESULT_BYTES) || 5_000_000,
  PTC_MAX_TOOL_HISTORY_TOTAL_BYTES: Number(process.env.PTC_MAX_TOOL_HISTORY_TOTAL_BYTES) || 40_000_000,
